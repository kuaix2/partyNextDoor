...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['event_name'])) {
    ...
    $sql = "INSERT INTO events (event_name, event_venue, event_date, event_price, event_tags, event_description, event_image) 
            VALUES ('$eventName', '$eventVenue', '$eventDate', '$eventPrice', '$eventTags', '$eventDescription', '$filePath')";
  ...
  <div class="dashboard-container">
    ...
    <div class="event-form">
      ...
      <form id="eventForm" action="dashboard.php" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" id="eventTags" name="event_tags">
